  ...
  <footer id="aa-footer">
    <div class="aa-footer-bottom">
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <span style="color: white;">20CS1H4205 - News Hub <?php echo date('Y'); ?> 
			</span>
      ...
      <span><a  style="color: white;" href="" data-toggle="modal" data-target="#adminlogin-modal">Admin Login</a></span>
      <span style="color: white;">|</span> 
      
      <span><a  style="color: white;" href="" data-toggle="modal" data-target="#reporterlogin-modal">Reporter Login</a></span>
        -->
			<?php
  ...
  <!--  Employee Login Modal ends here-->  
      ...
      <!--  Employee Login Modal starts here -->  
      <div class="modal fade" id="reporterlogin-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">                      
        <div class="modal-body">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4>Reporter Login Panel</h4><hr>
          <form class="aa-login-form" method="post" action="">
            <label for="">Username or Email address<span>*</span><span id="idemploginid" class="errmsg"></span></label>
            <input type="text" name="emploginid" placeholder="Login ID">
            <label for="">Password<span>*</span><span id="idemppassword" class="errmsg"></span></label>
            <input type="password" name="emppassword" placeholder="Password">
            <button class="aa-browse-btn" name="repsubmit" type="submit">Login</button>
           <br>  <br>  <br>  <br>
          </form>
        </div>                        
      </div><!--  /.modal-content -->
