...
{
	$sqledit = "UPDATE employee set password='" . md5($_POST['npassword']) . "' WHERE password='" . md5($_POST['opassword']) . "' AND employeeid='$_SESSION[employeeid]'";
	  ...
	  <div class="row">
		<div class="col-md-6">
		  <div class="aa-checkout-single-bill col-md-6">
			<input type="submit" name="submit" value="Change Password" class="aa-browse-btn">
		  </div>
		</div>		
	  </div>                                    
	</div>
