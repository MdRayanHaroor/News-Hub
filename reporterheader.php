...
if(isset($_POST['advtsubmit']))
{
	...
	{
		echo "<script>alert('Failed to Login. Check Credentials');</script>";	
	}
}
...
if(isset($_POST['repsubmit']))
{
    ...
    if(mysqli_affected_rows($con) == 1)
    {
      ...
      $_SESSION["emptype"] = $rs['emptype'];
      echo "<script>alert('Logged in successfully..');</script>";
      echo "<script>window.location='reporterdash.php';</script>";
    }
    else
    {
      echo "<script>alert('Failed to Login. Check Credentials');</script>";	
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.php">
                  ...
                  <div style="width:550px;">&nbsp;<strong>News Hub </strong> </div>
                </a>
                <!--  img based logo -->
...
<ul class="nav navbar-nav btn btn-info">
              <li STYLE="padding: 10px 15px;background-color: red;">REPORTER MENU >></li>			  
			  
              <li><a href="#">|</a></li>

              <li ><a href="reporterdash.php">Dashboard</a></li>	

              <li>
			          <a href="#">My Account<span class="caret"></span></a>
                <ul class="dropdown-menu">             
                  <li><a href="repempprofile.php">Profile</a></li>
  				        <li><a href="repemployeechangepassword.php">Change Password</a></li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul class="dropdown-menu">                
                      <li><a href="repnews.php?type=News">Publish News </a></li>
                      <!--<li><a href="repviewnews.php?type=News">View Published News</a></li>-->
                      <?php
              ...
              <li>
                ...
                <ul class="dropdown-menu">                
                      <li><a href="repnews.php?type=Article">Publish Article </a></li>
                      <!--<li><a href="repviewnews.php?type=Article">View Published Articles</a></li>-->
                      <?php
                      if($_SESSION["emptype"] == "Admin")					
                      {
                      ?>
...
?>  
  ...
  $i=0;
	...
	{
    echo "<a style='color: white;' href='newsdetailed.php?newsid=$rs[newsid]&newstype=$rs[newstype]&newscategoryid=$rs[newscategoryid]'>";
