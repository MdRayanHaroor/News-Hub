              ...
              <div class="aa-product-inner">
                <!--  start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#men" data-toggle="tab">Reporter Dashboard</a></li>
                  </ul>
                  <!--  Tab panes -->
                      ...
                      <ul class="aa-product-catg">
						...
						<li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn" href="viewnews.php">View</a>
                          </figure>                        
                          <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Number of records"><?php
						...
						<li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn" href="viewnewscategory.php">View</a>
                          </figure>                        
                          <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Number of records"><?php
